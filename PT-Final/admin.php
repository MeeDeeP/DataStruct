                ...
                <div class="row g-3 my-2">
                    <div class="col-md-3">
                        <div class="p-5 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <!-- <h4 class="fs-5">Cebu</h4> -->
                                <p>  <?php 
                                $query = "SELECT id from cebu ORDER BY id";
                    ...
                    <div class="col-md-3">
                        <div class="p-5 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <!-- <h3 class="fs-5">Manila</h3> -->
                                <!-- <p>  <?php 
                                $query = "SELECT id from manila ORDER BY id";
                                $query_run = mysqli_query($con, $query);
                                $row = mysqli_num_rows($query_run);
                                echo '<h4> manila: '.$row.'</h4>';
                                ?></p> -->
                            </div>
                            <!-- <i
                    ...
                    <div class="col-md-3">
                        <div class="p-5 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <!-- <h3 class="fs-5">Bohol</h3> -->
                                <p>  <?php 
                                $query = "SELECT id from bohol ORDER BY id";
                                $query_run = mysqli_query($con, $query);
                                $row = mysqli_num_rows($query_run);
                                echo '<h4> bohol: '.$row.'</h4>';
                                ?></p>
                            </div>
