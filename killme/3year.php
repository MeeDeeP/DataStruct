...
<section class="bg-secondary p-5">
        <p class="pb-2 fs-1 text-center">3rd year</p>
    <div class="card">
                                        ...
                                        foreach($query_run as $student) 
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="View3.php?id=<?= $student['id']; ?>" class="btn btn-primary btn-sm"><i class="bi bi-eye"></i></a>
                                                    <a href="Edit3.php?id=<?= $student['id']; ?>" class="btn btn-success btn-sm"><i class="bi bi-pencil-square"></i></a>
                                                    <form action="code.php" method="POST" class="d-inline">
                                                        <button type="submit" name="delete_student3" value="<?=$student['id'];?>" class="btn btn-danger btn-sm"><i class="bi bi-trash"></i></button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php
