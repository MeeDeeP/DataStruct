...
<section class="vh-100 gradient-custom bg-secondary">
        ...
        <div class="row justify-content-center align-items-center h-100">
            ...
            <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                ...
                <div class="card-header text-black text-center text-light bg bg-secondary ">
                        <h4>Update 
                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                ?>
                                    ...
                                    <a href="Edit1.php?id=<?= $student['id']; ?>"> <button type="submit" name="update1" class="btn btn-primary">
                                            Update
                                    </button></a>
                                    </div>
                                <?php
